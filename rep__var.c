...
/**
 * check_env - This checks if the typed variable is env variable
 *
 ...
 * @in: input string
 * @st: Rep last status of the Shell
...
/**
 * rep__var - This calls the functions to replace string into vars
 *
 * @input: input string
