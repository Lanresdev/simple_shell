...
/**
 * copy_info - copies informations to create
 * a new env or alias.
 * @name: name either env or alias.
 * @value: value either env or alias.
 *
...
/**
 * _setenv - this compares environment variables names
...
/**
 * _unsetenv - this deletes a environ variable
 *
